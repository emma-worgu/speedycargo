function getData() {
    try {
      ...
      console.log('API Response Data:', data); // Debug log to see what data is received

      // document.getElementById('track-input').value = data.trackNumber;
      document.getElementById('tr_code').textContent = data.trackNumber;
      document.getElementById('barcode-img').src = `https://barcode.tec-it.com/barcode.ashx?data=${data.trackNumber}&code=Code128`;
